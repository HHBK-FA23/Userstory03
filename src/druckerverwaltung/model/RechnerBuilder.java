...
import static druckerverwaltung.util.Utilities.isStringEmpty;
...
public class RechnerBuilder {
    ...
    public Rechner createRechner() {
        return new Rechner(seriennummer, modell, hersteller, status, herstellergarantie, lieferdatum, cpu, arbeitsspeicher, betriebssystem, typ, grafikkarte, festplatteSSD, festplatteHDD);
    }
}